...
<s:form id="minhaConta" action="save" namespace="/associado/conta">
    <p>
        <s:label key="label.nome" />
        <s:textfield name="associado.nome" disabled="true" />
        <span class="info"></span>
    </p>
    <p>
        <s:label key="label.cpfcnpj" />
        <s:textfield name="associado.cpfcnpj" disabled="true" />
        <span class="info"></span>
    </p>
    <p>
